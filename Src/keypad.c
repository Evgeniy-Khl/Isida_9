              ...
              switch (servis)
               {
                 ...
                 case 9:// сохр.знач.Зональности;    запишем FLAPOPEN;     добав.знач.Зональности  
                  ...
                  break;         // C9-> FLAPOPEN
                 case 10:  t->turnTime= buf&0x3FF; break;       // 10-> TURNTIME время ожидания прохода лотков в сек. 
                 case 11: t->waitCooling=(buf&0x3F)*6; break;// 11-> TIME OUT ожидания начала охлаждения в мин. 10 мин. *6 = 60(*10) -> 600 сек. 
              ...
              switch (servis)
               {
                 ...
                 case 9:// сохр.знач.Зональности;    запишем FLAPOPEN;         добав.знач.Зональности  
                  ...
                  break;         // C9-> FLAPOPEN
                 case 10:  t->turnTime= buf&0x3FF; break;       // 10 -> TURNTIME время ожидания прохода лотков в сек.
                 case 11: t->waitCooling=(buf&0x3F)*6; break;// 11-> TIME OUT ожидания начала охлаждения в мин. 10 мин. *6 = 60(*10) сек.
                 case 12://сохр.знач.гистерезиса;    запишем разрешения;      добав.знач.гистерезиса 
